...
public class historyListAdapter extends ArrayAdapter<historyEntry> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView txtStationName = rowView.findViewById(R.id.history_list_item_txtstationname);
        TextView txtLastVisited = rowView.findViewById(R.id.history_list_item_txttimevisited);
